...
if [ "$(uname)" == "Darwin" ]; then
    URL="https://mirror.openshift.com/pub/openshift-v4/clients/crc/1.32.1/crc-macos-amd64.tar.xz"
else  # CentOS 7
    URL="https://mirror.openshift.com/pub/openshift-v4/clients/crc/1.32.1/crc-linux-amd64.tar.xz"
    sudo yum update -y
